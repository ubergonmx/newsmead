...
private const val SEARCH_ARG_PARAM1 = "param1"
private const val SEARCH_ARG_PARAM2 = "param2"
...
class ArticleSearchFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            param1 = it.getString(SEARCH_ARG_PARAM1)
            param2 = it.getString(SEARCH_ARG_PARAM2)
        }
    }
...
//        }
    ...
    companion object {
         ...
         * @return A new instance of fragment ArticleSearchFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ArticleSearchFragment().apply {
                arguments = Bundle().apply {
                    putString(SEARCH_ARG_PARAM1, param1)
